def main():
    ...
    from nima.utils.score_utils import mean_score, std_score
...
def extract_features(img_path, resize=True):
    import sys
    sys.argv = ['evaluate_inception_resnet.py', '-img', img_path, '-resize', str(resize).lower()]
    return main()
